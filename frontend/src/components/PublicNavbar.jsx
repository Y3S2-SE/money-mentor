    ...
    >
      <div className={`flex justify-between items-center px-8 md:px-16 w-full max-w-[1920px] mx-auto transition-all duration-300 ${isScrolled ? 'py-4' : 'py-8'}`}>
        ...
        <div className="hidden lg:flex gap-12 items-center">
          <Link to="/" className="text-blue-100/40 hover:text-blue-100 transition-colors font-label tracking-[0.2em] text-[10px] uppercase font-semibold">Home</Link>
          <Link to="/features" className="text-blue-100/40 hover:text-blue-100 transition-colors font-label tracking-[0.2em] text-[10px] uppercase font-semibold">Features</Link>
          <Link to="/contact" className="text-blue-100/40 hover:text-blue-100 transition-colors font-label tracking-[0.2em] text-[10px] uppercase font-semibold">Contact</Link>
        </div>

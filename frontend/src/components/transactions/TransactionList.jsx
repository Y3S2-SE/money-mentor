                    ...
                    {transactions.map((tx) => (
                        ...
                        >
                            ...
                            <div className="hidden md:flex col-span-2 items-center gap-1">
                                ...
                                <span className={`text-xs font-label font-bold capitalize ${tx.type === 'income' ? 'text-emerald-600' : 'text-error'}`}>
                                    {tx.type}
                                </span>
                            </div>
                            ...
                            <div className="col-span-4 md:col-span-2 flex items-center justify-end gap-2">
                                <span className={`text-sm font-headline font-bold ${tx.type === 'income' ? 'text-emerald-600' : 'text-error'}`}>
